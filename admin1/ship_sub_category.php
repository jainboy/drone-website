...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		$update_status_sql="UPDATE product_categories set status='$status' where id='$id'";
...
$search=0;
 if(isset($_POST['search-txt']) && $_POST['search-txt']!=''){
    ...
    $sql.="WHERE `cat_name` LIKE '%$search%' OR `cat_description` LIKE '%$search%'";
}
$sql.="ORDER BY `sub_cat_name` ASC limit $start,$per_page";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button class="btn btn-info"> <a href="manage_product_sub_cat" class="alink"> Add New</a></button>
          </div>
          <div class="col-sm-6">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td> <?php   echo substr(strip_tags($row['sub_description']),0,50);  ?></td>
                      <td>	  <?php echo "<a href='manage_product_sub_cat?id=".$row['id']."'><i class='fa fa-edit text-info'></i></a>"; ?> </td>
