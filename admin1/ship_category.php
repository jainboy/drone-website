...
$sql.="ORDER BY `cat_name` ASC limit $start,$per_page";
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td> <?php   echo substr(strip_tags($row['cat_description']),0,50);  ?></td>
                      <td>	  <?php echo "<a href='manage_product_cat?id=".$row['id']."'><i class='fa fa-edit text-info'></i></a>"; ?> </td>
