...
include '../dbconnection/db.php';
 ...
 if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		$update_status_sql="update `sub-category` set status='$status' where id='$id'";
		mysqli_query($conn,$update_status_sql);
	}
	
	if($type=='delete'){
		$id=get_safe_value($conn,$_GET['id']);
		$delete_sql="delete from `sub-category` where id='$id'";
		mysqli_query($conn,$delete_sql);
	}
 }
 
 $sql="SELECT * FROM `sub-category` ORDER BY `sub_cat_name` ASC";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <!--new code copy-->
 <button type="button" class="new_button"> <a href="./manage_sub_categories.php">Add New</a></button>
                           ...
                           <div class="table-stats order-table ov-h">
                              <table class="table ">
                                 ...
                                 <tr>
									   ...
									   <td>
									  <?php echo "<span class='badge badge-edit'><a href='manage_sub_categories.php?id=".$row['id']."'><i class='fa fa-edit'></i></a></span>&nbsp;"; ?>
